...
//                        .frame(height: 60) // Adjust height for the selected option
...
//            )
//            
//            // Your content based on the selected index here
//        }
//            Picker("", selection: $segmentationSelection) {
//                ForEach(0..<options.count, id: \.self) { index in
//                    Text(options[index])
//                        .font(Font.system(size: 18, weight: .bold))
//                        .frame(width: 171.5, height: 40)
//                        .foregroundColor(segmentationSelection == index ? Color.green : Color.primary)
//                }
//            }
